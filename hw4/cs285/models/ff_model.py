...
class FFModel(nn.Module, BaseModel):
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        prediction, _ = self(obs, acs, **data_statistics)  #  get the predicted next-states (s_t+1) as a numpy array
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        next_obs_pred, delta_pred_normalized = self(observations, actions, **data_statistics)
