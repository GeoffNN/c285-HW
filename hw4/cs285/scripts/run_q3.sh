...
python cs285/scripts/run_hw4_mb.py --exp_name q3_reacher --env_name reacher-cs285-v0 --add_sl_noise \
    --mpc_horizon 10 --num_agent_train_steps_per_iter 1000 --batch_size_initial 5000 \
